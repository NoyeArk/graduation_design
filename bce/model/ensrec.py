...
class EnsRec(nn.Module):
    ...
    def forward(self, batch):
        ...
        Args:
            ...
            - item (`torch.Tensor`): 物品ID，形状为 [batch_size]
            - label (`torch.Tensor`): 用户是否点击，形状为 [batch_size]
            - base_model_scores (`torch.Tensor`): 基模型预测，形状为 [batch_size, n_base_model]
        ...
        target_emb = self.item_tower(batch['item'])  # bc, dim
