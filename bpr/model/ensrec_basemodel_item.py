...
class EnsRec(nn.Module):
    def __init__(self, args, data_args, n_user, n_item):
        ...
        self.dien = DIEN(hidden_dim=self.hidden_dim)
        self.user_embeddings = nn.Embedding(n_user, self.hidden_dim)
    ...
    def forward(self, batch, is_test=False):
        ...
        basemodel_emb1 = torch.sum(time_weights * basemodel_emb, dim=2)  # [bc, n_base_model, dim]
        basemodel_emb2 = self.base_model_emb  # [1, n_basemodel, dim]
        basemodel_emb = basemodel_emb1 + basemodel_emb2
